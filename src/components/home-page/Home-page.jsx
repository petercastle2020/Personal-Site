...
function Home() {
    ...
    <div>
        ...
        <div className="backgroundNoBlur">    
            <h3 className="desableBlur"><a href="#" target="_blank" rel="noopener noreferrer">Portfolio</a><a href="#" target="_blank" rel="noopener noreferrer">About</a><a href="#" target="_blank" rel="noopener noreferrer">Resume</a><a href="#" target="_blank" rel="noopener noreferrer">Contact</a></h3>     
        </div>
        </div>
        </div> 
